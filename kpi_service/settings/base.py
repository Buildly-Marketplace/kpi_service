"""
Django settings for kpi_service kpi.
...
# Build paths inside the kpi like this: os.path.join(BASE_DIR, ...)
...
WSGI_APPLICATION = 'kpi_service.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'kpi_service.permissions.AllowOptionsAuthentication',
    )
}
