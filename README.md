...
The KPI service is a set of backend models and REST services that can be connected to the Buildly Core and it's Users and Workflow components to create a project KPI tracker as well as  objectives and outcomes for each indicator. 
